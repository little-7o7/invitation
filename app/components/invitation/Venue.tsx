  ...
  return (
    <>
      <div className="venue-wrap rev-s">
        <img src="https://avatars.mds.yandex.net/get-altay/16557473/2a00000198bce33083c304f31d32ee619c96/orig" alt="Fotima Sultan Restaurant" loading="lazy"/>
      ...
      <div className="sec sec-framed rev bg-white" style={{'paddingTop':'clamp(44px,8vw,68px)','paddingBottom':'clamp(44px,8vw,68px)'}}>
        ...
        <p className="body-txt" style={{'fontSize':'clamp(14px,2.8vw,17px)'}}>{t.venueDesc}</p>
